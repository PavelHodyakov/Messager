...
public class BasemessageEntity {
    ...
    @Basic
    @Column(name = "recipient_id", nullable = false)//, updatable = true, insertable = true)
    ...
    @Basic
    @Column(name = "sender_id", nullable = false)//, updatable = true, insertable = true)
    ...
    @JoinColumn(name = "message_id", referencedColumnName = "id_message", insertable = false, updatable = false)
    ...
    @ManyToOne(fetch=FetchType.LAZY,optional=false)
    @JoinColumn(name = "recipient_id", referencedColumnName = "id_system", insertable = false, updatable = false)
    ...
    @ManyToOne(fetch=FetchType.LAZY,optional=false)
    @JoinColumn(name = "sender_id", referencedColumnName = "id_system", insertable = false, updatable = false)
